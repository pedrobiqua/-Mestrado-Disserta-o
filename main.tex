...
\input{packages}
% \usepackage{xcolor}
% \newcommand\pedro[1]{{\textcolor{green}{Pedro: #1}}}
...
% título
\title{Sk-d tree: Estrutura de Dados para fluxo de dados}

% palavras-chave e keywords (p/ resumo, abstract e metadados do PDF)
\pchave{Fluxo de dados 1. Árvore k-d 2. Aprendizagem de Máquina 3.}
\keyword{Data Streams 1. k-d tree 2. Machine Learning 3.}

% autoria
\author{Pedro Bianchini de Quadros}
\advisor{Paulo Ricardo Lisboa de Almeida}
\coadvisor{Jean Paul Barddal}
...
%     \includegraphics[width=\paperwidth,height=\paperheight]{0-iniciais/fundo-capa.png}
% }
